...
#
# Two variants (examples; PYTHON_VERSION optional):
...
# Install gemstone_utils from PyPI first; omit its line from requirements.txt for the rest.
RUN pip install --no-cache-dir --upgrade pip setuptools wheel \
    && pip install --no-cache-dir "gemstone_utils==${GEMSTONE_UTILS_REF}" \
