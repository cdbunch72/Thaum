...
| [**cloud**](cloud/README.md) | **Public cloud** (Azure Container Apps today)—see [Thaum Cloud](https://gemstone-software-dev.github.io/thaum-cloud/quickstart/azure/quickstart_aca.html) for Dockerfile, CI, and provisioning |
